...
getUsers(page? , itemPerPage?, userParams?, likerParam?): Observable<PaginatedResult<User[]>> {
  ...
  if (likerParam === 'Likers') {
    params = params.append('likers', 'true');
  }
  if (likerParam === 'Likees') {
    params = params.append('likees', 'true');
  }


  // return this.http.get<User[]>(this.baseUrl + 'users', httpOptios);
